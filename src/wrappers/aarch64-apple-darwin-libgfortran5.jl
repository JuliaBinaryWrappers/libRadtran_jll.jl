# Autogenerated wrapper script for libRadtran_jll for aarch64-apple-darwin-libgfortran5
...
JLLWrappers.@declare_library_product(libRadtran, "@rpath/libRadtran.so")
